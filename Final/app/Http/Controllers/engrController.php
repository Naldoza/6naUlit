...
class engrController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        return view('Engr.index', ['requests' => $requests]);
    }
    ...
    */
    ...
    {
        return view('Engr.show',['Request' => $Request]);
    }
    ...
    */
    public function store(Request $request)
    {
            ...
            return redirect(route('Engr.index'));
    }

    public function edit(Requests $Request)
    {

        return view('Engr.edit', compact('Request'));
    }
